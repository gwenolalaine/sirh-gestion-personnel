...
<form class="form-horizontal col-sm-offset-1 col-sm-9  col-sm-offset-1" method="post" action="ajouter" id="ajout">
    ...
    <div class="form-group">
        <label for="Adresse" class="col-sm-4" required>Adresse :</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" name="adresse">
        </div>
    </div>
    <div class="form-group">
        <label for="numero" class="col-sm-4" required>Numero de sécurité sociale:</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" name="numero">
        </div>
    </div>
    <div class="col-sm-offset-4 col-sm-8">
        <button type="submit" class="btn btn-default" name="creer">Créer</button>
    </div>
</form>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default" id="confirm">Confirmer</button>
            </div>
        </div>
...
<script>
	if ($('#nom').val() != "" && $('#prenom').val() != "" && $('#date').val() != "" && $('#adresse').val() != "" && $('#numero').val() != "") {
	    $('#modal').modal('show');
